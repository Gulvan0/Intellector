...
enum Phrase
{
    ...
    DRAW_OFFERED_MESSAGE(color:PieceColor);
    DRAW_CANCELLED_MESSAGE(color:PieceColor);
    DRAW_ACCEPTED_MESSAGE(color:PieceColor);
    DRAW_DECLINED_MESSAGE(color:PieceColor);
    TAKEBACK_OFFERED_MESSAGE(color:PieceColor);
    TAKEBACK_CANCELLED_MESSAGE(color:PieceColor);
    TAKEBACK_ACCEPTED_MESSAGE(color:PieceColor);
    TAKEBACK_DECLINED_MESSAGE(color:PieceColor);
