...
enum ServerEvent
{
    GameStarted(match_id:Int, logPreamble:String); //Called when the game featuring player starts. Signals to draw the gameboard. One of the answers to AcceptDirectChallenge. Also follows the DirectChallengeSent event unless DirectChallengeDeclined was emitted.
    SpectationData(match_id:Int, whiteSeconds:Float, blackSeconds:Float, timestamp:Float, currentLog:String); //Answer to Spectate. All the match details required
