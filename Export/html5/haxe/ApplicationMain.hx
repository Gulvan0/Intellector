...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Intellector", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Intellector", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Intellector";
		app.meta["name"] = "Intellector";
		app.meta["packageName"] = "com.sample.intellector";
