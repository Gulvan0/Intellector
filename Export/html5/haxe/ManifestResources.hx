...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_openings_dsv extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_symbols_delete_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_symbols_move_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:file("Assets/openings.dsv") @:noCompletion #if display private #end class __ASSET__assets_openings_dsv extends haxe.io.Bytes {}
...
@:keep @:image("Assets/symbols/delete.png") @:noCompletion #if display private #end class __ASSET__assets_symbols_delete_png extends lime.graphics.Image {}
@:keep @:image("Assets/symbols/move.png") @:noCompletion #if display private #end class __ASSET__assets_symbols_move_png extends lime.graphics.Image {}
