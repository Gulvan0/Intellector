...
enum Phrase
{
    ...
    MENUBAR_PLAY_MENU_VERSUS_BOT_ITEM;
    ...
    MENUBAR_SOCIAL_MENU_VK_ITEM;
    MENUBAR_SOCIAL_MENU_DISCORD_ITEM;

    MENUBAR_CHALLENGES_NO_CHALLENGES_PLACEHOLDER;
    ...
    MENUBAR_CHALLENGES_COPY_LINK_TEXT;
    ...
    SETTINGS_AUTOSCROLL_OPTION_NAME;
    ...
    SETTINGS_AUTOSCROLL_ALWAYS_OPTION_VALUE;
    SETTINGS_AUTOSCROLL_OWN_OPTION_VALUE;
    SETTINGS_AUTOSCROLL_NEVER_OPTION_VALUE;
    ...
    PROFILE_NO_FRIENDS_PLACEHOLDER;
    ...
    INCOMING_CHALLENGE_ACCEPT_ERROR_SERVER_SHUTDOWN;

    //SendChallenge success dialog

    SEND_DIRECT_CHALLENGE_SUCCESS_DIALOG_TITLE;
    SEND_DIRECT_CHALLENGE_SUCCESS_DIALOG_TEXT(opponentRef:PlayerRef);

    SEND_OPEN_CHALLENGE_SUCCESS_DIALOG_TITLE;
    SEND_OPEN_CHALLENGE_SUCCESS_DIALOG_TEXT;
    ...
    SEND_CHALLENGE_ERROR_DUPLICATE;
    SEND_CHALLENGE_ERROR_REMATCH_EXPIRED;
    SEND_CHALLENGE_ERROR_IMPOSSIBLE;
    SEND_CHALLENGE_ERROR_SERVER_SHUTDOWN;
    ...
    REQUESTS_FOLLOW_PLAYER_SUCCESS_DIALOG_TEXT;
    REQUESTS_FOLLOW_PLAYER_SUCCESS_DIALOG_TITLE;

    //Connection-related simple dialogs

    CONNECTION_LOST_ERROR;
    CONNECTION_ERROR_DIALOG_TITLE;
    SERVER_ERROR_DIALOG_TITLE;
    SERVER_ERROR_DIALOG_TEXT(errorMessage:String);
    SERVER_UNAVAILABLE_DIALOG_TEXT;
    SERVER_UNAVAILABLE_DIALOG_TITLE;
    SESSION_CLOSED_ALERT_TITLE;
    SESSION_CLOSED_ALERT_TEXT;
    RECONNECTION_POP_UP_TEXT;
    RECONNECTION_POP_UP_TITLE;

    //Greeting-related simple dialogs

    SERVER_IS_SHUTTING_DOWN_WARNING_TITLE;
    SERVER_IS_SHUTTING_DOWN_WARNING_TEXT;

    OUTDATED_CLIENT_ERROR_TITLE;
    OUTDATED_CLIENT_ERROR_TEXT;
    OUTDATED_SERVER_ERROR_TITLE;
    OUTDATED_SERVER_ERROR_TEXT;

    //Not sorted yet

    CHATBOX_MESSAGE_PLACEHOLDER;
    SPECTATOR_JOINED_MESSAGE(displayName:String);
    ...
    VIEW_REPORT_BTN_TOOLTIP;
    OPEN_CHAT_BTN_TOOLTIP;
    OPEN_BRANCHING_BTN_TOOLTIP;
    OPEN_GAME_INFO_BTN_TOOLTIP;
    OPEN_SPECIAL_CONTROL_SETTINGS_TOOLTIP;
    PREV_BTN_TOOLTIP;
    NEXT_BTN_TOOLTIP;

    CHAT_SUBSCREEN_NAME;
    BRANCHING_SUBSCREEN_NAME;
    GAME_INFO_SUBSCREEN_NAME;
    SPECIAL_CONTROL_SETTINGS_SUBSCREEN_NAME;
