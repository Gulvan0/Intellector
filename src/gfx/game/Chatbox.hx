...
class Chatbox extends VBox implements INetObserver
{
    ...
    private function onGameEnded(outcome:Outcome) 
    {
        ...
        haxe.ui.core.Screen.instance.unregisterEvent(KeyboardEvent.KEY_DOWN, onKeyPress);
    ...
    public function init(constructor:LiveGameConstructor)
    {
        ...
        haxe.ui.core.Screen.instance.registerEvent(KeyboardEvent.KEY_DOWN, onKeyPress);
    }
