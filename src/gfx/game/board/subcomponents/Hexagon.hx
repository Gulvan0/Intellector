...
import gfx.game.board.subcomponents.canvas.HexagonCircleCanvas;
import gfx.game.board.subcomponents.canvas.HexagonDotCanvas;
import gfx.game.board.subcomponents.canvas.HexagonCanvas;
