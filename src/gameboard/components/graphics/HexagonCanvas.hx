...
class HexagonCanvas extends Canvas
{
    ...
    public function new(dimensions:HexDimensions, state:HexagonSelectionState, dark:Bool, ?centerX:Float, ?centerY:Float) 
    {
        super();

        var borderThickness:Float = 0.075 * dimensions.sideLength;
        var borderColor:Color = Colors.border;
        var fillColor:Color = Colors.hexFill(state, dark);
