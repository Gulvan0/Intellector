...
import net.rest.models.game.submodels.EventKind;
...
class SpecialParsers
{
    ...
    public static function parsePlyEvent(fields:Map<String, JsonValue>, eventIndex:Int):GameEvent
    {
        ...
        return Ply(
            DateTime.fromIso(getString("ply", eventIndex, fields, "occured_at")),
            getInt("ply", eventIndex, fields, "ply_index"),
            new HexCoords(
                getInt("ply", eventIndex, fields, "from_i"),
                getInt("ply", eventIndex, fields, "from_j")
            ),
            new HexCoords(
                getInt("ply", eventIndex, fields, "to_i"),
                getInt("ply", eventIndex, fields, "to_j")
            ),
    ...
    {
        return ChatMessage(
            DateTime.fromIso(getString("chat_message", eventIndex, fields, "occured_at")),
    ...
    {
        return Offer(
            DateTime.fromIso(getString("offer", eventIndex, fields, "occured_at")),
    ...
    {
        return TimeAdded(
            DateTime.fromIso(getString("time_added", eventIndex, fields, "occured_at")),
    ...
    public static function parseRollbackEvent(fields:Map<String, JsonValue>, eventIndex:Int):GameEvent
    {
        var rawTimeUpdate:Null<JsonValue> = fields.get("time_update");
        return Rollback(
            DateTime.fromIso(getString("rollback", eventIndex, fields, "occured_at")),
