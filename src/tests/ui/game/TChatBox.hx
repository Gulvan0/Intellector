...
class AugmentedChatBox extends Chatbox
{
    ...
    public function new(ownerSpectator:Bool, ?data:ActualizationData)
    {
        ...
        messageInput.registerEvent(UIEvent.CHANGE, changeHandler);
    }
}
...
class TChatbox extends TestedComponent
{
    ...
    {
		return AdjustableContent(chatbox, LiveGame.MIN_SIDEBARS_WIDTH, LiveGame.MAX_SIDEBARS_WIDTH, 300, 800);
    }
